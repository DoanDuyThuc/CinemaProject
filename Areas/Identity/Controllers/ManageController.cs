...
namespace App.Areas.Identity.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        //lấy thông tin người dùng hiện tại từ HTTP request
        ...
        public async Task<IActionResult> DeleteUser(DeleteUserViewModel model){
            ...
            if (user == null)
            {
                // Người dùng không tồn tại, xử lý lỗi
            ...
            if (result.Succeeded)
            {
                // Xóa thành công, đăng xuất và chuyển hướng đến trang đăng nhập
                await _signInManager.SignOutAsync();
                return RedirectToAction("Login", "Account");
            }
            else
            {
                // Xử lý lỗi xóa tài khoản
                return View("Error");
            }
        }
